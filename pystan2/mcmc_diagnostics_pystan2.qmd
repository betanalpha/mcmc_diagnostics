...
```{.python include="stan_utility_pystan2.py" start-line=58 end-line=87}
```
...
```{.python include="stan_utility_pystan2.py" start-line=89 end-line=219}
```
...
```{.python include="stan_utility_pystan2.py" start-line=221 end-line=285}
```
...
```{.python include="stan_utility_pystan2.py" start-line=287 end-line=304}
```
...
```{.python include="stan_utility_pystan2.py" start-line=306 end-line=357}
```
...
```{.python include="stan_utility_pystan2.py" start-line=359 end-line=380}
```
...
```{.python include="stan_utility_pystan2.py" start-line=382 end-line=616}
```
...
```{.python include="stan_utility_pystan2.py" start-line=618 end-line=768}
```
...
```{.python include="stan_utility_pystan2.py" start-line=770 end-line=817}
```
...
```{.python include="stan_utility_pystan2.py" start-line=819 end-line=921}
```
...
```{.python include="stan_utility_pystan2.py" start-line=923 end-line=978}
```
...
```{.python include="stan_utility_pystan2.py" start-line=980 end-line=1052}
```
...
```{.python include="stan_utility_pystan2.py" start-line=1054 end-line=1224}
```
...
```{.python include="stan_utility_pystan2.py" start-line=1226 end-line=1377}
```
...
```{.python include="stan_utility_pystan2.py" start-line=1533 end-line=1630}
```
...
```{.python include="stan_utility_pystan2.py" start-line=1632 end-line=1708}
```
...
```{.python include="stan_utility_pystan2.py" start-line=1710 end-line=1785}
```
...
```{.python include="stan_utility_pystan2.py" start-line=1787 end-line=1867}
```
...
util.plot_div_pairs(base_samples, diagnostics, [0, 0, 0, 0])
```
...
```{python}
util.plot_div_pairs(base_samples, diagnostics, 
                    [0, 0, 0, 0], plot_mode=1)
```
