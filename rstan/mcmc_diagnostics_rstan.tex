...
\begin{Highlighting}[]
\NormalTok{plot\_inv\_metric }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(adaptation\_info, }\AttributeTok{B=}\DecValTok{25}\NormalTok{) \{}
\NormalTok{  adaptation\_info }\OtherTok{\textless{}{-}} \FunctionTok{get\_adaptation\_info}\NormalTok{(fit)}
\NormalTok{  C }\OtherTok{\textless{}{-}} \FunctionTok{length}\NormalTok{(adaptation\_info)}
...
{\centering \includegraphics{mcmc_diagnostics_rstan_files/figure-pdf/unnamed-chunk-9-1.pdf}
...
{\centering \includegraphics{mcmc_diagnostics_rstan_files/figure-pdf/unnamed-chunk-14-1.pdf}
...
{\centering \includegraphics{mcmc_diagnostics_rstan_files/figure-pdf/unnamed-chunk-23-1.pdf}
