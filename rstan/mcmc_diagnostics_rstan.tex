...
\NormalTok{    warning(sprintf(}\StringTok{\textquotesingle{}}\SpecialCharTok{\%s}\StringTok{ posterior samples (}\SpecialCharTok{\%.1f\%\%}\StringTok{) fell below the histogram binning.\textquotesingle{}}\NormalTok{,}
...
\NormalTok{    warning(sprintf(}\StringTok{\textquotesingle{}}\SpecialCharTok{\%s}\StringTok{ posterior samples (}\SpecialCharTok{\%.1f\%\%}\StringTok{) fell above the histogram binning.\textquotesingle{}}\NormalTok{,}
...
\includegraphics{mcmc_diagnostics_rstan_files/figure-pdf/unnamed-chunk-8-1.pdf}
...
\includegraphics{mcmc_diagnostics_rstan_files/figure-pdf/unnamed-chunk-11-1.pdf}
...
\includegraphics{mcmc_diagnostics_rstan_files/figure-pdf/unnamed-chunk-12-1.pdf}
...
\includegraphics{mcmc_diagnostics_rstan_files/figure-pdf/unnamed-chunk-13-1.pdf}
...
\includegraphics{mcmc_diagnostics_rstan_files/figure-pdf/unnamed-chunk-18-1.pdf}
...
\includegraphics{mcmc_diagnostics_rstan_files/figure-pdf/unnamed-chunk-19-1.pdf}
...
\includegraphics{mcmc_diagnostics_rstan_files/figure-pdf/unnamed-chunk-20-1.pdf}
...
\includegraphics{mcmc_diagnostics_rstan_files/figure-pdf/unnamed-chunk-21-1.pdf}
...
\includegraphics{mcmc_diagnostics_rstan_files/figure-pdf/unnamed-chunk-22-1.pdf}
