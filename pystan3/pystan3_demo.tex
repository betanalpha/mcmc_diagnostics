...
\CommentTok{\#         each Markov chain.}
\KeywordTok{def}\NormalTok{ pushforward\_chains(expectand\_vals, expectand):}
  \CommentTok{"""Evaluate an expectand along a Markov chain"""}
  \ControlFlowTok{return}\NormalTok{ numpy.vectorize(expectand)(expectand\_vals)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    indicator\_vals }\OperatorTok{=}\NormalTok{ pushforward\_chains(expectand\_vals, bin\_indicator)}
...
\begin{verbatim}
Last updated: 2024-09-04T18:46:26.087065-04:00
