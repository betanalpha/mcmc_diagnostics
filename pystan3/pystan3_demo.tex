...
\NormalTok{    name }\OperatorTok{=}\NormalTok{ re.sub(}\VerbatimStringTok{r\textquotesingle{}\textbackslash{}.\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}[\textquotesingle{}}\NormalTok{, base\_name, count}\OperatorTok{=}\DecValTok{1}\NormalTok{)}
\NormalTok{    name }\OperatorTok{=}\NormalTok{ re.sub(}\VerbatimStringTok{r\textquotesingle{}\textbackslash{}.\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{},\textquotesingle{}}\NormalTok{, name)}
...
\NormalTok{      local\_messages.append(}\SpecialStringTok{f\textquotesingle{}  Chain }\SpecialCharTok{\{}\NormalTok{c }\OperatorTok{+} \DecValTok{1}\SpecialCharTok{\}}\SpecialStringTok{: }\SpecialCharTok{\{}\NormalTok{n\_tds}\SpecialCharTok{:.0f\}}\SpecialStringTok{ of }\SpecialCharTok{\{}\NormalTok{S}\SpecialCharTok{\}}\SpecialStringTok{ \textquotesingle{}}
                            \SpecialStringTok{f\textquotesingle{}transitions (}\SpecialCharTok{\{}\NormalTok{n\_tds }\OperatorTok{/}\NormalTok{ S}\SpecialCharTok{:.3\%\}}\SpecialStringTok{)\textquotesingle{}}\NormalTok{)}
\NormalTok{      local\_messages.append(}\SpecialStringTok{f\textquotesingle{}           saturated the maximum \textquotesingle{}}
                            \SpecialStringTok{f\textquotesingle{}treedepth of }\SpecialCharTok{\{}\NormalTok{max\_treedepth}\SpecialCharTok{\}}\SpecialStringTok{.\textquotesingle{}}\NormalTok{)}
...
\NormalTok{      local\_messages.append(}\SpecialStringTok{f\textquotesingle{}  Chain }\SpecialCharTok{\{}\NormalTok{c }\OperatorTok{+} \DecValTok{1}\SpecialCharTok{\}}\SpecialStringTok{: Average proxy acceptance \textquotesingle{}}
                            \SpecialStringTok{f\textquotesingle{}statistic (}\SpecialCharTok{\{}\NormalTok{ave\_accept\_proxy}\SpecialCharTok{:.3f\}}\SpecialStringTok{)\textquotesingle{}}\NormalTok{)}
\NormalTok{      local\_messages.append(}\SpecialStringTok{f\textquotesingle{}           is smaller than 90\% of the \textquotesingle{}}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Plot a histogram of the split hat\{R\}s for all expectands in}
\CommentTok{\# expectands\_var\_list.  Plot range and number of bins expands to}
\CommentTok{\# include the split hat\{R\} threshold.}
\CommentTok{\# @param ax Matplotlib axis object}
\CommentTok{\# @param expectand\_vals\_dict A dictionary of two{-}dimensional arrays for}
\CommentTok{\#                            each expectand.  The first dimension of}
\CommentTok{\#                            each element indexes the Markov chains and}
\CommentTok{\#                            the second dimension indexes the sequential}
\CommentTok{\#                            states within each Markov chain.}
\CommentTok{\# @params B The number of histogram bins}
\KeywordTok{def}\NormalTok{ plot\_rhats(ax, expectand\_vals\_dict, B}\OperatorTok{=}\DecValTok{25}\NormalTok{):}
\NormalTok{  validate\_dict\_of\_arrays(expectand\_vals\_dict,}
                          \StringTok{\textquotesingle{}expectand\_vals\_dict\textquotesingle{}}\NormalTok{)}

\NormalTok{  N }\OperatorTok{=} \BuiltInTok{len}\NormalTok{(expectand\_vals\_dict)}
\NormalTok{  rhats }\OperatorTok{=}\NormalTok{ [ numpy.nan ] }\OperatorTok{*}\NormalTok{ N}
...
\NormalTok{    rhat }\OperatorTok{=}\NormalTok{ compute\_split\_rhat(expectand\_vals)}
    \ControlFlowTok{if}\NormalTok{ math.isfinite(rhat):}
\NormalTok{      rhats[n] }\OperatorTok{=}\NormalTok{ rhat}
\NormalTok{    n }\OperatorTok{+=} \DecValTok{1}

\NormalTok{  val\_min }\OperatorTok{=}\NormalTok{ numpy.nanmin(rhats)}
\NormalTok{  val\_max }\OperatorTok{=}\NormalTok{ numpy.nanmax(rhats)}

\NormalTok{  plot\_min }\OperatorTok{=} \BuiltInTok{min}\NormalTok{(}\FloatTok{1.1}\NormalTok{, val\_min)}
\NormalTok{  plot\_max }\OperatorTok{=} \BuiltInTok{max}\NormalTok{(}\FloatTok{1.1}\NormalTok{, val\_max)}
\NormalTok{  B }\OperatorTok{=}\NormalTok{ B }\OperatorTok{*} \BuiltInTok{int}\NormalTok{((plot\_max }\OperatorTok{{-}}\NormalTok{ plot\_min) }\OperatorTok{/}\NormalTok{ (val\_max }\OperatorTok{{-}}\NormalTok{ val\_min))}

\NormalTok{  delta }\OperatorTok{=}\NormalTok{ (plot\_max }\OperatorTok{{-}}\NormalTok{ plot\_min) }\OperatorTok{/}\NormalTok{ B}
\NormalTok{  plot\_min }\OperatorTok{=}\NormalTok{ plot\_min }\OperatorTok{{-}}\NormalTok{ delta}
\NormalTok{  plot\_max }\OperatorTok{=}\NormalTok{ plot\_max }\OperatorTok{+}\NormalTok{ delta}
\NormalTok{  bins }\OperatorTok{=}\NormalTok{ numpy.arange(plot\_min, plot\_max }\OperatorTok{+}\NormalTok{ delta, delta)}
\NormalTok{  B }\OperatorTok{=}\NormalTok{ B }\OperatorTok{+} \DecValTok{2}

\NormalTok{  idxs }\OperatorTok{=}\NormalTok{ [ idx }\ControlFlowTok{for}\NormalTok{ idx }\KeywordTok{in} \BuiltInTok{range}\NormalTok{(B) }\ControlFlowTok{for}\NormalTok{ r }\KeywordTok{in} \BuiltInTok{range}\NormalTok{(}\DecValTok{2}\NormalTok{) ]}
\NormalTok{  xs }\OperatorTok{=}\NormalTok{ [ bins[idx }\OperatorTok{+}\NormalTok{ delta] }\ControlFlowTok{for}\NormalTok{ idx }\KeywordTok{in} \BuiltInTok{range}\NormalTok{(B) }\ControlFlowTok{for}\NormalTok{ delta }\KeywordTok{in}\NormalTok{ [}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{]]}

\NormalTok{  counts }\OperatorTok{=}\NormalTok{ numpy.histogram(rhats, bins}\OperatorTok{=}\NormalTok{bins)[}\DecValTok{0}\NormalTok{]}
\NormalTok{  max\_y }\OperatorTok{=} \BuiltInTok{max}\NormalTok{(counts)}
\NormalTok{  ys }\OperatorTok{=}\NormalTok{ counts[idxs]}

\NormalTok{  ax.plot(xs, ys, dark, linewidth}\OperatorTok{=}\DecValTok{1}\NormalTok{)}
\NormalTok{  ax.set\_xlabel(}\StringTok{"Split hatRs"}\NormalTok{)}
\NormalTok{  ax.set\_xlim([plot\_min, plot\_max])}
\NormalTok{  ax.set\_ylabel(}\StringTok{""}\NormalTok{)}
\NormalTok{  ax.get\_yaxis().set\_visible(}\VariableTok{False}\NormalTok{)}
\NormalTok{  ax.set\_ylim([}\DecValTok{0}\NormalTok{, }\FloatTok{1.05} \OperatorTok{*}\NormalTok{ max\_y])}
\NormalTok{  ax.spines[}\StringTok{"top"}\NormalTok{].set\_visible(}\VariableTok{False}\NormalTok{)}
\NormalTok{  ax.spines[}\StringTok{"left"}\NormalTok{].set\_visible(}\VariableTok{False}\NormalTok{)}
\NormalTok{  ax.spines[}\StringTok{"right"}\NormalTok{].set\_visible(}\VariableTok{False}\NormalTok{)}

\NormalTok{  ax.axvline(x}\OperatorTok{=}\FloatTok{1.1}\NormalTok{, linewidth}\OperatorTok{=}\DecValTok{2}\NormalTok{, linestyle}\OperatorTok{=}\StringTok{"dashed"}\NormalTok{, color}\OperatorTok{=}\StringTok{"\#DDDDDD"}\NormalTok{)}
...
\NormalTok{  N }\OperatorTok{=} \BuiltInTok{len}\NormalTok{(vals)}
\NormalTok{  m }\OperatorTok{=}\NormalTok{ welford\_summary(vals)[}\DecValTok{0}\NormalTok{]}
...
\NormalTok{  acov\_buff }\OperatorTok{=}\NormalTok{ numpy.real(Rs)}
  \ControlFlowTok{if}\NormalTok{ acov\_buff[}\DecValTok{0}\NormalTok{] }\OperatorTok{==} \DecValTok{0}\NormalTok{:}
...
\NormalTok{      rhos[}\DecValTok{2} \OperatorTok{*}\NormalTok{ p }\OperatorTok{+} \DecValTok{1}\NormalTok{] }\OperatorTok{=} \FloatTok{0.5} \OperatorTok{*}\NormalTok{ old\_pair\_sum}
    ...
    \ControlFlowTok{if}\NormalTok{ p }\OperatorTok{==}\NormalTok{ P }\OperatorTok{{-}} \DecValTok{1}\NormalTok{:}
      \ControlFlowTok{return}\NormalTok{ math.nan}
...
\NormalTok{    tau\_hat }\OperatorTok{=}\NormalTok{ compute\_tau\_hat(expectand\_vals[c,:])}
    ...
    \ControlFlowTok{if}\NormalTok{ math.isinf(tau\_hat):}
      \BuiltInTok{print}\NormalTok{(}\SpecialStringTok{f\textquotesingle{}Chain }\SpecialCharTok{\{}\NormalTok{c }\OperatorTok{+} \DecValTok{1}\SpecialCharTok{\}}\SpecialStringTok{: The calculation of hat}\CharTok{\{\{}\SpecialStringTok{tau}\CharTok{\}\}}\SpecialStringTok{ is \textquotesingle{}}\NormalTok{,}
             \StringTok{\textquotesingle{}unreliable because}\CharTok{\textbackslash{}n}\StringTok{the empirical variance \textquotesingle{}}\NormalTok{,}
             \StringTok{\textquotesingle{}is zero.}\CharTok{\textbackslash{}n}\StringTok{\textquotesingle{}}\NormalTok{)}
\NormalTok{      no\_warning }\OperatorTok{=} \VariableTok{False}
    \ControlFlowTok{elif}\NormalTok{ math.isnan(tau\_hat):}
      \BuiltInTok{print}\NormalTok{(}\SpecialStringTok{f\textquotesingle{}Chain }\SpecialCharTok{\{}\NormalTok{c }\OperatorTok{+} \DecValTok{1}\SpecialCharTok{\}}\SpecialStringTok{: The calculation of hat}\CharTok{\{\{}\SpecialStringTok{tau}\CharTok{\}\}}\SpecialStringTok{ is \textquotesingle{}}\NormalTok{,}
             \StringTok{\textquotesingle{}unreliable because}\CharTok{\textbackslash{}n}\StringTok{the empirical \textquotesingle{}}\NormalTok{,}
             \StringTok{\textquotesingle{}autocorrelations did not decay sufficiently \textquotesingle{}}\NormalTok{,}
             \StringTok{\textquotesingle{}quickly.}\CharTok{\textbackslash{}n}\StringTok{\textquotesingle{}}\NormalTok{)}
\NormalTok{      no\_warning }\OperatorTok{=} \VariableTok{False}
...
\NormalTok{    inc\_tau\_hat }\OperatorTok{=}\NormalTok{ tau\_hat }\OperatorTok{/}\NormalTok{ S}
    \ControlFlowTok{if}\NormalTok{ inc\_tau\_hat }\OperatorTok{\textgreater{}} \DecValTok{5}\NormalTok{:}
      \BuiltInTok{print}\NormalTok{(}\SpecialStringTok{f\textquotesingle{}Chain }\SpecialCharTok{\{}\NormalTok{c }\OperatorTok{+} \DecValTok{1}\SpecialCharTok{\}}\SpecialStringTok{: Incremental hat}\CharTok{\{\{}\SpecialStringTok{tau}\CharTok{\}\}}\SpecialStringTok{ \textquotesingle{}}
            \SpecialStringTok{f\textquotesingle{}(}\SpecialCharTok{\{}\NormalTok{inc\_tau\_hat }\SpecialCharTok{:.3f\}}\SpecialStringTok{) is too large.}\CharTok{\textbackslash{}n}\SpecialStringTok{\textquotesingle{}}\NormalTok{)}
\NormalTok{      no\_warning }\OperatorTok{=} \VariableTok{False}

  \ControlFlowTok{if}\NormalTok{ no\_warning:}
\NormalTok{    desc }\OperatorTok{=}\NormalTok{ (}\StringTok{\textquotesingle{}The incremental empirical integrated \textquotesingle{}}\NormalTok{,}
            \StringTok{\textquotesingle{}autocorrelation time is sufficiently well{-}behaved \textquotesingle{}}\NormalTok{,}
            \StringTok{\textquotesingle{}for the empirical autocorrelation estimates to be \textquotesingle{}}\NormalTok{,}
            \StringTok{\textquotesingle{}reliable.\textquotesingle{}}\NormalTok{)}
\NormalTok{    desc }\OperatorTok{=}\NormalTok{ textwrap.wrap(desc, max\_width)}
\NormalTok{    desc.append(}\StringTok{\textquotesingle{} \textquotesingle{}}\NormalTok{)}
    \BuiltInTok{print}\NormalTok{(}\StringTok{\textquotesingle{}}\CharTok{\textbackslash{}n}\StringTok{\textquotesingle{}}\NormalTok{.join(desc))}
  \ControlFlowTok{else}\NormalTok{:}
\NormalTok{    desc }\OperatorTok{=}\NormalTok{ (}\StringTok{\textquotesingle{}If the incremental empirical integrated \textquotesingle{}}\NormalTok{,}
            \StringTok{\textquotesingle{}autocorrelation times are unreliable or too large \textquotesingle{}}\NormalTok{,}
            \StringTok{\textquotesingle{}then the Markov chains have not explored long \textquotesingle{}}\NormalTok{,}
            \StringTok{\textquotesingle{}enough for the autocorrelation estimates to be \textquotesingle{}}\NormalTok{,}
            \StringTok{\textquotesingle{}reliable.\textquotesingle{}}\NormalTok{)}
\NormalTok{    desc }\OperatorTok{=}\NormalTok{ textwrap.wrap(desc, max\_width)}
\NormalTok{    desc.append(}\StringTok{\textquotesingle{} \textquotesingle{}}\NormalTok{)}
    \BuiltInTok{print}\NormalTok{(}\StringTok{\textquotesingle{}}\CharTok{\textbackslash{}n}\StringTok{\textquotesingle{}}\NormalTok{.join(desc))}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Plot a histogram of the empirical effective sample sizes for all}
\CommentTok{\# expectands in expectands\_var\_list, separated by Markov chain.}
\CommentTok{\# Plot range and number of bins expands to include the min\_ess\_hat}
...
\CommentTok{\#                            the second dimension indexes the sequential}
\CommentTok{\#                            states within each Markov chain.}
\CommentTok{\# @param min\_ess\_hat The minimum empirical effective sample size}
\CommentTok{\# @params B The number of histogram bins}
\KeywordTok{def}\NormalTok{ plot\_ess\_hats(expectand\_vals\_dict,}
\NormalTok{                  min\_ess\_hat}\OperatorTok{=}\DecValTok{100}\NormalTok{, B}\OperatorTok{=}\DecValTok{25}\NormalTok{):}
\NormalTok{  validate\_dict\_of\_arrays(expectand\_vals\_dict,}
                          \StringTok{\textquotesingle{}expectand\_vals\_dict\textquotesingle{}}\NormalTok{)}

\NormalTok{  N }\OperatorTok{=} \BuiltInTok{len}\NormalTok{(expectand\_vals\_dict)}

\NormalTok{  [name, ev] }\OperatorTok{=} \BuiltInTok{next}\NormalTok{(}\BuiltInTok{iter}\NormalTok{(expectand\_vals\_dict.items()))}
\NormalTok{  validate\_array(ev, }\SpecialStringTok{f\textquotesingle{}expectand\_vals\_dict[}\SpecialCharTok{\{}\NormalTok{name}\SpecialCharTok{\}}\SpecialStringTok{]\textquotesingle{}}\NormalTok{)}

\NormalTok{  C }\OperatorTok{=}\NormalTok{ ev.shape[}\DecValTok{0}\NormalTok{]}
\NormalTok{  S }\OperatorTok{=}\NormalTok{ ev.shape[}\DecValTok{1}\NormalTok{]}
\NormalTok{  ess\_hats }\OperatorTok{=}\NormalTok{ numpy.zeros((C, N))}
...
\NormalTok{    validate\_array(expectand\_vals, }\StringTok{\textquotesingle{}expectand\_vals\textquotesingle{}}\NormalTok{)}
    ...
    \ControlFlowTok{for}\NormalTok{ c }\KeywordTok{in} \BuiltInTok{range}\NormalTok{(C):}
\NormalTok{      tau\_hat }\OperatorTok{=}\NormalTok{ compute\_tau\_hat(expectand\_vals[c,:])}
\NormalTok{      ess\_hats[c, n] }\OperatorTok{=}\NormalTok{ S }\OperatorTok{/}\NormalTok{ tau\_hat}
\NormalTok{    n }\OperatorTok{+=} \DecValTok{1}

\NormalTok{  val\_min }\OperatorTok{=}\NormalTok{ numpy.nanmin(ess\_hats)}
\NormalTok{  val\_max }\OperatorTok{=}\NormalTok{ numpy.nanmax(ess\_hats)}
...
\NormalTok{  max\_y }\OperatorTok{=} \BuiltInTok{max}\NormalTok{([ }\BuiltInTok{max}\NormalTok{(numpy.histogram(ess\_hats[c,:], bins}\OperatorTok{=}\NormalTok{bins)[}\DecValTok{0}\NormalTok{])}
                \ControlFlowTok{for}\NormalTok{ c }\KeywordTok{in} \BuiltInTok{range}\NormalTok{(C) ])}
...
\NormalTok{  k }\OperatorTok{=} \DecValTok{0}
  ...
  \ControlFlowTok{for}\NormalTok{ c }\KeywordTok{in} \BuiltInTok{range}\NormalTok{(C):}
\NormalTok{    counts }\OperatorTok{=}\NormalTok{ numpy.histogram(ess\_hats[c,:], bins}\OperatorTok{=}\NormalTok{bins)[}\DecValTok{0}\NormalTok{]}
\NormalTok{    ys }\OperatorTok{=}\NormalTok{ counts[idxs]}
...
\NormalTok{    axarr[idx1, idx2].set\_xlabel(}\StringTok{"Empirical Effective Sample Sizes"}\NormalTok{)}
\NormalTok{    axarr[idx1, idx2].set\_xlim([plot\_min, plot\_max])}
\NormalTok{    axarr[idx1, idx2].set\_ylabel(}\StringTok{""}\NormalTok{)}
\NormalTok{    axarr[idx1, idx2].get\_yaxis().set\_visible(}\VariableTok{False}\NormalTok{)}
\NormalTok{    axarr[idx1, idx2].set\_ylim([}\DecValTok{0}\NormalTok{, }\FloatTok{1.05} \OperatorTok{*}\NormalTok{ max\_y])}
\NormalTok{    axarr[idx1, idx2].spines[}\StringTok{"top"}\NormalTok{].set\_visible(}\VariableTok{False}\NormalTok{)}
...
\NormalTok{    axarr[idx1, idx2].axvline(x}\OperatorTok{=}\NormalTok{min\_ess\_hat, linewidth}\OperatorTok{=}\DecValTok{2}\NormalTok{,}
\NormalTok{                              linestyle}\OperatorTok{=}\StringTok{"dashed"}\NormalTok{,}
\NormalTok{                              color}\OperatorTok{=}\StringTok{"\#DDDDDD"}\NormalTok{)}
...
\NormalTok{        local\_warning }\OperatorTok{=} \VariableTok{True}
\NormalTok{        local\_message }\OperatorTok{+=}\NormalTok{ (}\SpecialStringTok{f\textquotesingle{}Chain }\SpecialCharTok{\{}\NormalTok{c }\OperatorTok{+} \DecValTok{1}\SpecialCharTok{\}}\SpecialStringTok{: The calculation of \textquotesingle{}}\NormalTok{,}
                           \StringTok{\textquotesingle{}hat}\SpecialCharTok{\{\{}\StringTok{tau}\SpecialCharTok{\}\}}\StringTok{ is unreliable because}\CharTok{\textbackslash{}n}\StringTok{the \textquotesingle{}}\NormalTok{,}
                           \StringTok{\textquotesingle{}empirical variance is zero.}\CharTok{\textbackslash{}n}\StringTok{\textquotesingle{}}\NormalTok{)}
      \ControlFlowTok{elif}\NormalTok{ math.isnan(tau\_hat):}
\NormalTok{        no\_inc\_tau\_hat\_warning }\OperatorTok{=} \VariableTok{False}
\NormalTok{        local\_warning }\OperatorTok{=} \VariableTok{True}
        \BuiltInTok{print}\NormalTok{(}\SpecialStringTok{f\textquotesingle{}Chain }\SpecialCharTok{\{}\NormalTok{c }\OperatorTok{+} \DecValTok{1}\SpecialCharTok{\}}\SpecialStringTok{: The calculation of hat}\CharTok{\{\{}\SpecialStringTok{tau}\CharTok{\}\}}\SpecialStringTok{ is \textquotesingle{}}\NormalTok{,}
...
\NormalTok{          local\_message }\OperatorTok{+=}\NormalTok{ (}\SpecialStringTok{f\textquotesingle{}Chain }\SpecialCharTok{\{}\NormalTok{c }\OperatorTok{+} \DecValTok{1}\SpecialCharTok{\}}\SpecialStringTok{: Incremental hat}\CharTok{\{\{}\SpecialStringTok{tau}\CharTok{\}\}}\SpecialStringTok{ \textquotesingle{}}
                            \SpecialStringTok{f\textquotesingle{}(}\SpecialCharTok{\{}\NormalTok{inc\_tau\_hat }\SpecialCharTok{:.31\}}\SpecialStringTok{) is too large.}\CharTok{\textbackslash{}n}\SpecialStringTok{\textquotesingle{}}\NormalTok{)}
...
\NormalTok{      tau\_hat }\OperatorTok{=}\NormalTok{ compute\_tau\_hat(expectand\_vals[c,:])}
      ...
      \CommentTok{\# Check incremental empirical integrated autocorrelation time}
      \ControlFlowTok{if}\NormalTok{ math.isinf(tau\_hat) }\KeywordTok{or}\NormalTok{ math.isnan(tau\_hat) }\KeywordTok{or}\NormalTok{ (tau\_hat }\OperatorTok{/}\NormalTok{ S) }\OperatorTok{\textgreater{}} \DecValTok{5}\NormalTok{:}
\NormalTok{        failed\_names.append(name)}
...
\NormalTok{      array\_names }\OperatorTok{=}\NormalTok{ [ key }\ControlFlowTok{for}\NormalTok{ key }\KeywordTok{in}\NormalTok{ expectand\_vals\_dict.keys()}
                      \ControlFlowTok{if}\NormalTok{ re.match(}\StringTok{\textquotesingle{}\^{}\textquotesingle{}} \OperatorTok{+}\NormalTok{ name }\OperatorTok{+} \VerbatimStringTok{r\textquotesingle{}\textbackslash{}[\textquotesingle{}}\NormalTok{, key) ]}
...
\NormalTok{  unique\_vals }\OperatorTok{=} \BuiltInTok{set}\NormalTok{(indicator\_samples.flatten())}
  ...
  \ControlFlowTok{if} \KeywordTok{not}\NormalTok{ (   unique\_vals }\OperatorTok{==} \BuiltInTok{set}\NormalTok{([}\DecValTok{0}\NormalTok{])}
          \KeywordTok{or}\NormalTok{ unique\_vals }\OperatorTok{==} \BuiltInTok{set}\NormalTok{([}\DecValTok{1}\NormalTok{])}
          \KeywordTok{or}\NormalTok{ unique\_vals }\OperatorTok{==} \BuiltInTok{set}\NormalTok{([}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{])):}
...
\NormalTok{      min\_f }\OperatorTok{=} \BuiltInTok{min}\NormalTok{(min\_f, baseline)}
\NormalTok{      max\_f }\OperatorTok{=} \BuiltInTok{max}\NormalTok{(max\_f, baseline)}
...
\begin{verbatim}
/Users/Betancourt/Documents/Research/Code/pystan3.12/pystan3.12_env/lib/python3.12/site-packages/stan/plugins.py:4: UserWarning: pkg_resources is deprecated as an API. See https://setuptools.pypa.io/en/latest/pkg_resources.html. The pkg_resources package is slated for removal as early as 2025-11-30. Refrain from using this package or pin to Setuptools<81.
...
\begin{verbatim}
  Chain 1: 1011 of 1024 transitions (98.73%) diverged.
  Chain 1: Average proxy acceptance statistic (0.685)
  ...
  Chain 4: 1014 of 1024 transitions (99.02%) diverged.
  Chain 4: Average proxy acceptance statistic (0.717)
           is smaller than 90% of the target (0.801).
...
\includegraphics{pystan3_demo_files/figure-pdf/cell-8-output-1.png}
...
\begin{verbatim}
Chain 1: Integrator Step Size = 3.92e-02
Chain 2: Integrator Step Size = 1.32e-02
Chain 3: Integrator Step Size = 3.00e-02
Chain 4: Integrator Step Size = 5.09e-02
\end{verbatim}
...
\begin{verbatim}
Chain 1: Average proxy acceptance statistic = 0.685
Chain 2: Average proxy acceptance statistic = 0.844
Chain 3: Average proxy acceptance statistic = 0.756
Chain 4: Average proxy acceptance statistic = 0.717
\end{verbatim}
...
\includegraphics{pystan3_demo_files/figure-pdf/cell-11-output-1.png}
...
\includegraphics{pystan3_demo_files/figure-pdf/cell-12-output-1.png}
...
\includegraphics{pystan3_demo_files/figure-pdf/cell-13-output-1.png}
...
y_pred[100], y_pred[101], y_pred[104], y_pred[105], y_pred[106],
y_pred[107], y_pred[10], y_pred[112], y_pred[114], y_pred[117],
y_pred[119], y_pred[11], y_pred[120], y_pred[121], y_pred[126],
y_pred[128], y_pred[132], y_pred[133], y_pred[134], y_pred[135],
y_pred[136], y_pred[137], y_pred[138], y_pred[141], y_pred[142],
y_pred[143], y_pred[145], y_pred[146], y_pred[148], y_pred[14],
y_pred[150], y_pred[152], y_pred[154], y_pred[156], y_pred[159],
y_pred[15], y_pred[160], y_pred[161], y_pred[165], y_pred[166],
y_pred[16], y_pred[172], y_pred[173], y_pred[176], y_pred[179],
y_pred[182], y_pred[187], y_pred[190], y_pred[193], y_pred[197],
y_pred[198], y_pred[199], y_pred[1], y_pred[200], y_pred[206],
y_pred[208], y_pred[209], y_pred[210], y_pred[212], y_pred[217],
y_pred[219], y_pred[221], y_pred[223], y_pred[225], y_pred[226],
y_pred[228], y_pred[229], y_pred[22], y_pred[231], y_pred[232],
y_pred[236], y_pred[237], y_pred[238], y_pred[239], y_pred[240],
y_pred[243], y_pred[247], y_pred[249], y_pred[251], y_pred[253],
y_pred[255], y_pred[257], y_pred[258], y_pred[260], y_pred[261],
y_pred[262], y_pred[263], y_pred[264], y_pred[265], y_pred[266],
y_pred[267], y_pred[268], y_pred[269], y_pred[271], y_pred[274],
y_pred[275], y_pred[277], y_pred[279], y_pred[27], y_pred[280],
y_pred[284], y_pred[290], y_pred[293], y_pred[294], y_pred[295],
y_pred[298], y_pred[29], y_pred[300], y_pred[302], y_pred[303],
y_pred[307], y_pred[308], y_pred[309], y_pred[310], y_pred[315],
y_pred[317], y_pred[319], y_pred[321], y_pred[323], y_pred[324],
y_pred[327], y_pred[328], y_pred[329], y_pred[32], y_pred[331],
y_pred[332], y_pred[333], y_pred[338], y_pred[339], y_pred[341],
y_pred[346], y_pred[347], y_pred[349], y_pred[34], y_pred[351],
y_pred[352], y_pred[354], y_pred[355], y_pred[358], y_pred[360],
y_pred[361], y_pred[362], y_pred[367], y_pred[368], y_pred[369],
y_pred[36], y_pred[370], y_pred[372], y_pred[378], y_pred[37],
y_pred[380], y_pred[382], y_pred[383], y_pred[385], y_pred[387],
y_pred[388], y_pred[393], y_pred[395], y_pred[399], y_pred[39],
y_pred[401], y_pred[402], y_pred[403], y_pred[404], y_pred[405],
y_pred[406], y_pred[408], y_pred[411], y_pred[413], y_pred[415],
y_pred[416], y_pred[417], y_pred[418], y_pred[41], y_pred[424],
y_pred[425], y_pred[426], y_pred[428], y_pred[430], y_pred[432],
y_pred[435], y_pred[437], y_pred[439], y_pred[441], y_pred[442],
y_pred[443], y_pred[445], y_pred[446], y_pred[447], y_pred[451],
y_pred[452], y_pred[453], y_pred[454], y_pred[455], y_pred[457],
y_pred[45], y_pred[460], y_pred[461], y_pred[462], y_pred[467],
y_pred[469], y_pred[46], y_pred[471], y_pred[473], y_pred[474],
y_pred[476], y_pred[477], y_pred[478], y_pred[47], y_pred[483],
y_pred[484], y_pred[485], y_pred[486], y_pred[487], y_pred[493],
y_pred[497], y_pred[498], y_pred[499], y_pred[49], y_pred[500],
y_pred[501], y_pred[503], y_pred[508], y_pred[509], y_pred[50],
y_pred[510], y_pred[513], y_pred[518], y_pred[51], y_pred[520],
y_pred[521], y_pred[525], y_pred[526], y_pred[528], y_pred[529],
y_pred[52], y_pred[531], y_pred[536], y_pred[537], y_pred[53],
y_pred[540], y_pred[544], y_pred[548], y_pred[550], y_pred[555],
y_pred[557], y_pred[560], y_pred[561], y_pred[562], y_pred[563],
y_pred[567], y_pred[569], y_pred[570], y_pred[571], y_pred[572],
y_pred[573], y_pred[574], y_pred[575], y_pred[577], y_pred[583],
y_pred[586], y_pred[589], y_pred[591], y_pred[592], y_pred[593],
y_pred[594], y_pred[595], y_pred[596], y_pred[599], y_pred[59],
y_pred[5], y_pred[602], y_pred[605], y_pred[606], y_pred[607],
y_pred[608], y_pred[609], y_pred[610], y_pred[613], y_pred[615],
y_pred[617], y_pred[619], y_pred[61], y_pred[624], y_pred[625],
y_pred[626], y_pred[628], y_pred[629], y_pred[62], y_pred[631],
y_pred[632], y_pred[633], y_pred[634], y_pred[635], y_pred[636],
y_pred[637], y_pred[638], y_pred[639], y_pred[63], y_pred[640],
y_pred[641], y_pred[644], y_pred[645], y_pred[646], y_pred[648],
y_pred[649], y_pred[650], y_pred[651], y_pred[652], y_pred[653],
y_pred[655], y_pred[656], y_pred[658], y_pred[65], y_pred[660],
y_pred[662], y_pred[666], y_pred[669], y_pred[671], y_pred[674],
y_pred[675], y_pred[676], y_pred[681], y_pred[682], y_pred[684],
y_pred[685], y_pred[687], y_pred[691], y_pred[697], y_pred[699],
y_pred[69], y_pred[703], y_pred[705], y_pred[706], y_pred[707],
y_pred[709], y_pred[70], y_pred[713], y_pred[716], y_pred[718],
y_pred[719], y_pred[71], y_pred[720], y_pred[721], y_pred[722],
y_pred[723], y_pred[724], y_pred[725], y_pred[72], y_pred[730],
y_pred[732], y_pred[734], y_pred[735], y_pred[738], y_pred[740],
y_pred[741], y_pred[743], y_pred[746], y_pred[747], y_pred[74],
y_pred[750], y_pred[755], y_pred[756], y_pred[760], y_pred[761],
y_pred[763], y_pred[765], y_pred[766], y_pred[769], y_pred[774],
y_pred[775], y_pred[776], y_pred[779], y_pred[77], y_pred[780],
y_pred[781], y_pred[784], y_pred[786], y_pred[78], y_pred[791],
y_pred[792], y_pred[795], y_pred[799], y_pred[79], y_pred[802],
y_pred[805], y_pred[806], y_pred[807], y_pred[809], y_pred[80],
y_pred[812], y_pred[813], y_pred[814], y_pred[815], y_pred[819],
y_pred[81], y_pred[821], y_pred[822], y_pred[823], y_pred[824],
y_pred[825], y_pred[827], y_pred[828], y_pred[829], y_pred[82],
y_pred[830], y_pred[832], y_pred[833], y_pred[834], y_pred[836],
y_pred[837], y_pred[842], y_pred[844], y_pred[845], y_pred[846],
y_pred[848], y_pred[850], y_pred[852], y_pred[853], y_pred[854],
y_pred[855], y_pred[856], y_pred[860], y_pred[862], y_pred[865],
y_pred[866], y_pred[867], y_pred[868], y_pred[869], y_pred[870],
y_pred[872], y_pred[876], y_pred[879], y_pred[87], y_pred[882],
y_pred[883], y_pred[885], y_pred[886], y_pred[88], y_pred[891],
y_pred[892], y_pred[898], y_pred[902], y_pred[904], y_pred[906],
y_pred[907], y_pred[909], y_pred[90], y_pred[910], y_pred[913],
y_pred[915], y_pred[916], y_pred[917], y_pred[91], y_pred[921],
y_pred[923], y_pred[924], y_pred[928], y_pred[92], y_pred[930],
y_pred[931], y_pred[932], y_pred[939], y_pred[93], y_pred[940],
y_pred[942], y_pred[943], y_pred[945], y_pred[949], y_pred[950],
y_pred[954], y_pred[955], y_pred[960], y_pred[961], y_pred[965],
y_pred[970], y_pred[971], y_pred[972], y_pred[973], y_pred[974],
y_pred[975], y_pred[976], y_pred[978], y_pred[980], y_pred[981],
y_pred[982], y_pred[983], y_pred[985], y_pred[987], y_pred[995],
y_pred[996], y_pred[999], y_pred[9] triggered diagnostic warnings.
 
The expectands y_pred[100], y_pred[101], y_pred[104], y_pred[105],
y_pred[106], y_pred[107], y_pred[10], y_pred[112], y_pred[114],
y_pred[117], y_pred[119], y_pred[11], y_pred[120], y_pred[121],
y_pred[126], y_pred[128], y_pred[132], y_pred[133], y_pred[134],
y_pred[135], y_pred[136], y_pred[137], y_pred[138], y_pred[141],
y_pred[142], y_pred[143], y_pred[145], y_pred[146], y_pred[148],
y_pred[14], y_pred[150], y_pred[152], y_pred[154], y_pred[156],
y_pred[159], y_pred[15], y_pred[160], y_pred[161], y_pred[165],
y_pred[166], y_pred[16], y_pred[172], y_pred[173], y_pred[176],
y_pred[179], y_pred[182], y_pred[187], y_pred[190], y_pred[193],
y_pred[197], y_pred[198], y_pred[199], y_pred[1], y_pred[200],
y_pred[206], y_pred[208], y_pred[209], y_pred[210], y_pred[212],
y_pred[217], y_pred[219], y_pred[221], y_pred[223], y_pred[225],
y_pred[226], y_pred[228], y_pred[229], y_pred[22], y_pred[231],
y_pred[232], y_pred[236], y_pred[237], y_pred[238], y_pred[239],
y_pred[240], y_pred[243], y_pred[247], y_pred[249], y_pred[251],
y_pred[253], y_pred[255], y_pred[257], y_pred[258], y_pred[260],
y_pred[261], y_pred[262], y_pred[263], y_pred[264], y_pred[265],
y_pred[266], y_pred[267], y_pred[268], y_pred[269], y_pred[271],
y_pred[274], y_pred[275], y_pred[277], y_pred[279], y_pred[27],
y_pred[280], y_pred[284], y_pred[290], y_pred[293], y_pred[294],
y_pred[295], y_pred[298], y_pred[29], y_pred[300], y_pred[302],
y_pred[303], y_pred[307], y_pred[308], y_pred[309], y_pred[310],
y_pred[315], y_pred[317], y_pred[319], y_pred[321], y_pred[323],
y_pred[324], y_pred[327], y_pred[328], y_pred[329], y_pred[32],
y_pred[331], y_pred[332], y_pred[333], y_pred[338], y_pred[339],
y_pred[341], y_pred[346], y_pred[347], y_pred[349], y_pred[34],
y_pred[351], y_pred[352], y_pred[354], y_pred[355], y_pred[358],
y_pred[360], y_pred[361], y_pred[362], y_pred[367], y_pred[368],
y_pred[369], y_pred[36], y_pred[370], y_pred[372], y_pred[378],
y_pred[37], y_pred[380], y_pred[382], y_pred[383], y_pred[385],
y_pred[387], y_pred[388], y_pred[393], y_pred[395], y_pred[399],
y_pred[39], y_pred[401], y_pred[402], y_pred[403], y_pred[404],
y_pred[405], y_pred[406], y_pred[408], y_pred[411], y_pred[413],
y_pred[415], y_pred[416], y_pred[417], y_pred[418], y_pred[41],
y_pred[424], y_pred[425], y_pred[426], y_pred[428], y_pred[430],
y_pred[432], y_pred[435], y_pred[437], y_pred[439], y_pred[441],
y_pred[442], y_pred[443], y_pred[445], y_pred[446], y_pred[447],
y_pred[451], y_pred[452], y_pred[453], y_pred[454], y_pred[455],
y_pred[457], y_pred[45], y_pred[460], y_pred[461], y_pred[462],
y_pred[467], y_pred[469], y_pred[46], y_pred[471], y_pred[473],
y_pred[474], y_pred[476], y_pred[477], y_pred[478], y_pred[47],
y_pred[483], y_pred[484], y_pred[485], y_pred[486], y_pred[487],
y_pred[493], y_pred[497], y_pred[498], y_pred[499], y_pred[49],
y_pred[500], y_pred[501], y_pred[503], y_pred[508], y_pred[509],
y_pred[50], y_pred[510], y_pred[513], y_pred[518], y_pred[51],
y_pred[520], y_pred[521], y_pred[525], y_pred[526], y_pred[528],
y_pred[529], y_pred[52], y_pred[531], y_pred[536], y_pred[537],
y_pred[53], y_pred[540], y_pred[544], y_pred[548], y_pred[550],
y_pred[555], y_pred[557], y_pred[560], y_pred[561], y_pred[562],
y_pred[563], y_pred[567], y_pred[569], y_pred[570], y_pred[571],
y_pred[572], y_pred[573], y_pred[574], y_pred[575], y_pred[577],
y_pred[583], y_pred[586], y_pred[589], y_pred[591], y_pred[592],
y_pred[593], y_pred[594], y_pred[595], y_pred[596], y_pred[599],
y_pred[59], y_pred[5], y_pred[602], y_pred[605], y_pred[606],
y_pred[607], y_pred[608], y_pred[609], y_pred[610], y_pred[613],
y_pred[615], y_pred[617], y_pred[619], y_pred[61], y_pred[624],
y_pred[625], y_pred[626], y_pred[628], y_pred[629], y_pred[62],
y_pred[631], y_pred[632], y_pred[633], y_pred[634], y_pred[635],
y_pred[636], y_pred[637], y_pred[638], y_pred[639], y_pred[63],
y_pred[640], y_pred[641], y_pred[644], y_pred[645], y_pred[646],
y_pred[648], y_pred[649], y_pred[650], y_pred[651], y_pred[652],
y_pred[653], y_pred[655], y_pred[656], y_pred[658], y_pred[65],
y_pred[660], y_pred[662], y_pred[666], y_pred[669], y_pred[671],
y_pred[674], y_pred[675], y_pred[676], y_pred[681], y_pred[682],
y_pred[684], y_pred[685], y_pred[687], y_pred[691], y_pred[697],
y_pred[699], y_pred[69], y_pred[703], y_pred[705], y_pred[706],
y_pred[707], y_pred[709], y_pred[70], y_pred[713], y_pred[716],
y_pred[718], y_pred[719], y_pred[71], y_pred[720], y_pred[721],
y_pred[722], y_pred[723], y_pred[724], y_pred[725], y_pred[72],
y_pred[730], y_pred[732], y_pred[734], y_pred[735], y_pred[738],
y_pred[740], y_pred[741], y_pred[743], y_pred[746], y_pred[747],
y_pred[74], y_pred[750], y_pred[755], y_pred[756], y_pred[760],
y_pred[761], y_pred[763], y_pred[765], y_pred[766], y_pred[769],
y_pred[774], y_pred[775], y_pred[776], y_pred[779], y_pred[77],
y_pred[780], y_pred[781], y_pred[784], y_pred[786], y_pred[78],
y_pred[791], y_pred[792], y_pred[795], y_pred[799], y_pred[79],
y_pred[802], y_pred[805], y_pred[806], y_pred[807], y_pred[809],
y_pred[80], y_pred[812], y_pred[813], y_pred[814], y_pred[815],
y_pred[819], y_pred[81], y_pred[821], y_pred[822], y_pred[823],
y_pred[824], y_pred[825], y_pred[827], y_pred[828], y_pred[829],
y_pred[82], y_pred[830], y_pred[832], y_pred[833], y_pred[834],
y_pred[836], y_pred[837], y_pred[842], y_pred[844], y_pred[845],
y_pred[846], y_pred[848], y_pred[850], y_pred[852], y_pred[853],
y_pred[854], y_pred[855], y_pred[856], y_pred[860], y_pred[862],
y_pred[865], y_pred[866], y_pred[867], y_pred[868], y_pred[869],
y_pred[870], y_pred[872], y_pred[876], y_pred[879], y_pred[87],
y_pred[882], y_pred[883], y_pred[885], y_pred[886], y_pred[88],
y_pred[891], y_pred[892], y_pred[898], y_pred[902], y_pred[904],
y_pred[906], y_pred[907], y_pred[909], y_pred[90], y_pred[910],
y_pred[913], y_pred[915], y_pred[916], y_pred[917], y_pred[91],
y_pred[921], y_pred[923], y_pred[924], y_pred[928], y_pred[92],
y_pred[930], y_pred[931], y_pred[932], y_pred[939], y_pred[93],
y_pred[940], y_pred[942], y_pred[943], y_pred[945], y_pred[949],
y_pred[950], y_pred[954], y_pred[955], y_pred[960], y_pred[961],
y_pred[965], y_pred[970], y_pred[971], y_pred[972], y_pred[973],
y_pred[974], y_pred[975], y_pred[976], y_pred[978], y_pred[980],
y_pred[981], y_pred[982], y_pred[983], y_pred[985], y_pred[987],
y_pred[995], y_pred[996], y_pred[999], y_pred[9] triggered tail hat{xi}
warnings.
  Large tail hat{xi}s suggest that the expectand might not be
sufficiently integrable.
 
The expectands alpha, beta[1], beta[2], beta[3], p[100], p[101], p[102],
p[103], p[104], p[105], p[106], p[107], p[108], p[109], p[10], p[111],
p[112], p[113], p[114], p[115], p[116], p[117], p[118], p[119], p[11],
p[121], p[122], p[124], p[125], p[126], p[127], p[128], p[129], p[12],
p[130], p[131], p[132], p[133], p[135], p[136], p[137], p[138], p[13],
p[140], p[141], p[143], p[144], p[145], p[146], p[148], p[149], p[14],
p[150], p[151], p[152], p[153], p[154], p[155], p[156], p[159], p[15],
p[160], p[161], p[162], p[163], p[165], p[166], p[167], p[168], p[16],
p[170], p[172], p[173], p[174], p[175], p[176], p[177], p[178], p[179],
p[17], p[180], p[181], p[182], p[183], p[185], p[186], p[187], p[188],
p[189], p[18], p[190], p[191], p[192], p[193], p[194], p[196], p[197],
p[198], p[199], p[19], p[1], p[200], p[201], p[202], p[203], p[204],
p[205], p[206], p[207], p[208], p[209], p[210], p[212], p[214], p[215],
p[216], p[217], p[218], p[219], p[21], p[220], p[221], p[222], p[223],
p[224], p[225], p[226], p[227], p[228], p[229], p[22], p[230], p[231],
p[232], p[233], p[234], p[235], p[236], p[237], p[238], p[239], p[240],
p[241], p[242], p[243], p[244], p[245], p[246], p[247], p[248], p[249],
p[24], p[250], p[251], p[252], p[253], p[254], p[255], p[258], p[260],
p[261], p[262], p[263], p[264], p[265], p[266], p[267], p[268], p[269],
p[26], p[270], p[271], p[272], p[274], p[275], p[276], p[277], p[278],
p[279], p[27], p[280], p[282], p[284], p[285], p[286], p[287], p[288],
p[28], p[290], p[291], p[293], p[294], p[295], p[296], p[297], p[298],
p[299], p[29], p[2], p[300], p[301], p[302], p[303], p[304], p[305],
p[307], p[308], p[309], p[310], p[311], p[314], p[315], p[317], p[318],
p[319], p[31], p[321], p[323], p[324], p[325], p[326], p[327], p[328],
p[329], p[32], p[331], p[332], p[333], p[334], p[337], p[338], p[33],
p[340], p[341], p[342], p[344], p[345], p[346], p[347], p[34], p[351],
p[352], p[353], p[354], p[355], p[356], p[358], p[359], p[35], p[361],
p[362], p[363], p[364], p[365], p[366], p[367], p[368], p[369], p[36],
p[370], p[372], p[373], p[375], p[377], p[378], p[37], p[380], p[382],
p[383], p[384], p[385], p[386], p[387], p[388], p[389], p[38], p[393],
p[394], p[395], p[396], p[397], p[398], p[399], p[39], p[3], p[400],
p[401], p[402], p[403], p[404], p[405], p[406], p[408], p[410], p[411],
p[412], p[413], p[415], p[416], p[417], p[418], p[41], p[420], p[421],
p[422], p[423], p[424], p[425], p[427], p[428], p[429], p[42], p[430],
p[431], p[432], p[433], p[434], p[435], p[436], p[437], p[438], p[439],
p[43], p[441], p[442], p[443], p[445], p[446], p[447], p[448], p[449],
p[44], p[452], p[453], p[455], p[456], p[457], p[459], p[45], p[460],
p[461], p[462], p[463], p[464], p[465], p[467], p[468], p[469], p[46],
p[470], p[471], p[472], p[473], p[474], p[476], p[477], p[478], p[479],
p[47], p[480], p[482], p[483], p[484], p[485], p[486], p[487], p[489],
p[490], p[491], p[492], p[493], p[494], p[495], p[496], p[497], p[498],
p[499], p[49], p[4], p[500], p[501], p[502], p[503], p[505], p[506],
p[507], p[508], p[509], p[50], p[510], p[511], p[512], p[513], p[514],
p[515], p[516], p[517], p[518], p[519], p[51], p[520], p[522], p[523],
p[524], p[525], p[526], p[527], p[528], p[529], p[531], p[532], p[534],
p[535], p[536], p[537], p[538], p[539], p[53], p[540], p[541], p[543],
p[545], p[547], p[548], p[549], p[54], p[550], p[551], p[552], p[553],
p[555], p[557], p[558], p[559], p[55], p[560], p[561], p[562], p[563],
p[564], p[565], p[567], p[568], p[56], p[570], p[571], p[573], p[575],
p[576], p[577], p[578], p[579], p[57], p[580], p[581], p[583], p[584],
p[585], p[586], p[587], p[589], p[58], p[590], p[591], p[592], p[593],
p[594], p[595], p[596], p[597], p[598], p[599], p[59], p[5], p[601],
p[602], p[603], p[604], p[605], p[606], p[607], p[608], p[609], p[610],
p[611], p[612], p[613], p[614], p[615], p[616], p[617], p[618], p[619],
p[61], p[621], p[622], p[623], p[624], p[625], p[626], p[628], p[629],
p[62], p[630], p[631], p[632], p[633], p[634], p[635], p[636], p[637],
p[638], p[639], p[63], p[640], p[641], p[643], p[644], p[645], p[646],
p[647], p[648], p[649], p[64], p[650], p[651], p[652], p[653], p[654],
p[655], p[656], p[657], p[659], p[65], p[660], p[661], p[662], p[664],
p[665], p[666], p[669], p[66], p[671], p[674], p[675], p[676], p[678],
p[679], p[67], p[681], p[682], p[683], p[684], p[685], p[686], p[687],
p[688], p[689], p[68], p[691], p[693], p[694], p[695], p[696], p[697],
p[698], p[699], p[69], p[6], p[700], p[701], p[702], p[703], p[704],
p[705], p[706], p[707], p[708], p[709], p[70], p[710], p[711], p[712],
p[713], p[714], p[715], p[716], p[717], p[718], p[719], p[71], p[720],
p[721], p[722], p[723], p[724], p[725], p[726], p[727], p[729], p[72],
p[730], p[732], p[733], p[734], p[735], p[737], p[738], p[739], p[73],
p[740], p[741], p[742], p[743], p[744], p[745], p[746], p[747], p[748],
p[749], p[74], p[750], p[751], p[752], p[753], p[754], p[755], p[756],
p[757], p[758], p[759], p[760], p[761], p[763], p[765], p[766], p[767],
p[769], p[76], p[770], p[771], p[772], p[773], p[774], p[775], p[776],
p[777], p[778], p[779], p[77], p[780], p[781], p[782], p[784], p[785],
p[786], p[787], p[788], p[789], p[78], p[790], p[791], p[792], p[793],
p[794], p[795], p[796], p[797], p[798], p[799], p[79], p[7], p[800],
p[801], p[802], p[804], p[805], p[806], p[807], p[809], p[80], p[810],
p[811], p[812], p[813], p[814], p[815], p[816], p[818], p[819], p[81],
p[820], p[821], p[822], p[823], p[824], p[825], p[826], p[827], p[828],
p[829], p[82], p[830], p[831], p[832], p[833], p[834], p[835], p[836],
p[837], p[838], p[83], p[840], p[841], p[842], p[843], p[844], p[845],
p[846], p[848], p[849], p[850], p[852], p[853], p[854], p[855], p[856],
p[857], p[858], p[859], p[85], p[860], p[862], p[863], p[864], p[865],
p[866], p[867], p[868], p[869], p[86], p[870], p[872], p[873], p[874],
p[875], p[876], p[879], p[87], p[881], p[882], p[883], p[886], p[887],
p[888], p[889], p[88], p[890], p[891], p[892], p[893], p[894], p[895],
p[896], p[898], p[89], p[8], p[900], p[901], p[902], p[904], p[905],
p[906], p[907], p[908], p[909], p[90], p[910], p[911], p[913], p[914],
p[915], p[916], p[917], p[918], p[919], p[91], p[920], p[922], p[923],
p[924], p[925], p[926], p[928], p[929], p[92], p[930], p[931], p[932],
p[933], p[934], p[936], p[938], p[939], p[93], p[940], p[941], p[942],
p[943], p[945], p[946], p[948], p[949], p[94], p[950], p[951], p[952],
p[953], p[954], p[955], p[957], p[958], p[959], p[960], p[961], p[962],
p[963], p[964], p[965], p[966], p[968], p[970], p[971], p[972], p[973],
p[974], p[975], p[976], p[977], p[978], p[979], p[97], p[980], p[981],
p[982], p[984], p[985], p[986], p[987], p[989], p[990], p[991], p[992],
p[993], p[994], p[995], p[996], p[997], p[999], p[99], p[9] triggered
hat{R} warnings.
...
That is a lot of diagnostic failures.

Visualizing the split \(\hat{R}\) and empirical effective sample sizes
with histograms is a bit more manageable.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{util.plot\_rhats(plot.gca(), samples)}
\NormalTok{plot.show()}
\end{Highlighting}
\end{Shaded}

\includegraphics{pystan3_demo_files/figure-pdf/cell-15-output-1.png}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{util.plot\_ess\_hats(samples)}
\end{Highlighting}
\end{Shaded}

\includegraphics{pystan3_demo_files/figure-pdf/cell-16-output-1.png}

That said, we can also avoid overwhelming ourselves by focus on just the
...
\begin{verbatim}
alpha:
  Split hat{R} (1.185) exceeds 1.1.
  Chain 1: hat{ESS} (10.8) is smaller than desired (100).
  Chain 2: hat{ESS} (4.8) is smaller than desired (100).
  Chain 3: hat{ESS} (17.2) is smaller than desired (100).
  Chain 4: hat{ESS} (5.0) is smaller than desired (100).

beta[1]:
  Split hat{R} (1.513) exceeds 1.1.
  Chain 1: hat{ESS} (7.0) is smaller than desired (100).
  Chain 2: hat{ESS} (4.1) is smaller than desired (100).
  Chain 3: hat{ESS} (12.7) is smaller than desired (100).
  Chain 4: hat{ESS} (5.0) is smaller than desired (100).

beta[2]:
  Split hat{R} (1.134) exceeds 1.1.
  Chain 1: hat{ESS} (11.7) is smaller than desired (100).
  Chain 2: hat{ESS} (4.4) is smaller than desired (100).
  Chain 3: hat{ESS} (14.2) is smaller than desired (100).
  Chain 4: hat{ESS} (12.4) is smaller than desired (100).

beta[3]:
  Split hat{R} (1.475) exceeds 1.1.
  Chain 1: hat{ESS} (6.7) is smaller than desired (100).
  Chain 2: hat{ESS} (3.6) is smaller than desired (100).
  Chain 3: hat{ESS} (11.2) is smaller than desired (100).
  Chain 4: hat{ESS} (4.6) is smaller than desired (100).
...
\includegraphics{pystan3_demo_files/figure-pdf/cell-18-output-1.png}
...
\includegraphics{pystan3_demo_files/figure-pdf/cell-19-output-1.png}
...
\includegraphics{pystan3_demo_files/figure-pdf/cell-20-output-1.png}
...
\includegraphics{pystan3_demo_files/figure-pdf/cell-21-output-1.png}
...
\includegraphics{pystan3_demo_files/figure-pdf/cell-22-output-1.png}
...
\includegraphics{pystan3_demo_files/figure-pdf/cell-23-output-1.png}
...
\includegraphics{pystan3_demo_files/figure-pdf/cell-24-output-1.png}
...
\includegraphics{pystan3_demo_files/figure-pdf/cell-25-output-1.png}
...
\begin{verbatim}
Posterior probability that beta[2] is greater than zero = 0.97 +/- 0.043.
\end{verbatim}
...
\begin{verbatim}
Last updated: 2026-08-01T21:52:40.460924-04:00
