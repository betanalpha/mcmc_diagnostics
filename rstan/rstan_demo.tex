...
\NormalTok{      local\_message }\OperatorTok{\textless{}{-}} 
\NormalTok{        paste0(local\_message,}
\NormalTok{               sprintf(}\StringTok{\textquotesingle{}  Chain }\SpecialCharTok{\%s}\StringTok{: }\SpecialCharTok{\%s}\StringTok{ of }\SpecialCharTok{\%s}\StringTok{ transitions (}\SpecialCharTok{\%.3f\%\%}\StringTok{) \textquotesingle{}}\NormalTok{,}
...
\CommentTok{\# Summarize Hamiltonian Monte Carlo and expectand diagnostics}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Recursively create vector of element names, including indexing}
\end{Highlighting}
\end{Shaded}
