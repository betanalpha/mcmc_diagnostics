...
\KeywordTok{def}\NormalTok{ plot\_inv\_metric(stan\_fit, B}\OperatorTok{=}\DecValTok{25}\NormalTok{):}
  \CommentTok{"""Plot outcome of inverse metric adaptation"""}
\NormalTok{  chain\_info }\OperatorTok{=}\NormalTok{ stan\_fit.get\_adaptation\_info()}
...
\NormalTok{    clean1 }\OperatorTok{=}\NormalTok{ re.sub(}\VerbatimStringTok{r"\# Adaptation terminated\textbackslash{}n\# Step size = [0{-}9.]*\textbackslash{}n\#"}\NormalTok{,}
                    \StringTok{""}\NormalTok{, raw\_info)}
\NormalTok{    clean2 }\OperatorTok{=}\NormalTok{ re.sub(}\VerbatimStringTok{r" [a{-}zA{-}Z ]*:\textbackslash{}n\# "}\NormalTok{, }\StringTok{""}\NormalTok{, clean1)}
\NormalTok{    clean3 }\OperatorTok{=}\NormalTok{ re.sub(}\VerbatimStringTok{r"\textbackslash{}n$"}\NormalTok{, }\StringTok{""}\NormalTok{, clean2)}
...
\includegraphics{pystan2_demo_files/figure-pdf/cell-9-output-1.pdf}
...
\includegraphics{pystan2_demo_files/figure-pdf/cell-12-output-1.pdf}
...
\includegraphics{pystan2_demo_files/figure-pdf/cell-13-output-1.pdf}
...
\includegraphics{pystan2_demo_files/figure-pdf/cell-14-output-1.pdf}
...
\includegraphics{pystan2_demo_files/figure-pdf/cell-16-output-1.pdf}
...
\includegraphics{pystan2_demo_files/figure-pdf/cell-17-output-1.pdf}
...
\includegraphics{pystan2_demo_files/figure-pdf/cell-19-output-1.pdf}
...
\includegraphics{pystan2_demo_files/figure-pdf/cell-20-output-1.pdf}
...
\includegraphics{pystan2_demo_files/figure-pdf/cell-21-output-1.pdf}
...
\includegraphics{pystan2_demo_files/figure-pdf/cell-22-output-1.pdf}
...
\includegraphics{pystan2_demo_files/figure-pdf/cell-23-output-1.pdf}
...
\includegraphics{pystan2_demo_files/figure-pdf/cell-24-output-1.pdf}
...
\includegraphics{pystan2_demo_files/figure-pdf/cell-25-output-1.pdf}
...
\includegraphics{pystan2_demo_files/figure-pdf/cell-26-output-1.pdf}
...
\begin{verbatim}
Last updated: 2026-08-01T21:47:21.592165-04:00
